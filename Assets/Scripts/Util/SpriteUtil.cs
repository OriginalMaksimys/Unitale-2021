...
public static class SpriteUtil
{
    ...
    public static Sprite fromFile(string filename)
    {
      ...
      Sprite newSprite = Sprite.Create(SpriteTexture, new Rect(0, 0, SpriteTexture.width, SpriteTexture.height), new Vector2(0, 0), PIXELS_PER_UNIT);
    
      // Опциональная обработка XML
      ...
      if (fi.Exists)
      {
          ...
          {
              newSprite = spriteWithXml(xmld["spritesheet"].FirstChild, newSprite);
          }
      }
